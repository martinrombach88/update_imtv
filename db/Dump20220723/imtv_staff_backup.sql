...
CREATE TABLE `staff_backup` (
  ...
  `nameENG` varchar(45) DEFAULT NULL,
  `nameKR` varchar(45) DEFAULT NULL,
  `infoKR` longtext,
  `infoENG` longtext,
  PRIMARY KEY (`id`)
...
LOCK TABLES `staff_backup` WRITE;
/*!40000 ALTER TABLE `staff_backup` DISABLE KEYS */;
/*!40000 ALTER TABLE `staff_backup` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-07-23 21:14:45
